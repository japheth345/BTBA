...
public class ListItemAdapter1 extends RecyclerView.Adapter<ListItemAdapter1.ViewHolder> {
    ...
    public ListItemAdapter1(List<Vehicle> itemList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        */
        ...
        holder.price_tv.setText("Route:\n "+ listItem.getRoute());
        holder.status.setText("Departure: \n "+listItem.getDeparture());
        holder.cap.setText("Capacity: \n"+listItem.getSeats());
        holder.rem.setText("Empty Slots:\n "+listItem.getRseats());
